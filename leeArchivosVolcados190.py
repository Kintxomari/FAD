...
def main():
	...
	#dir_folder='/home/kintxo/adjuntos/190Seguriti/'
...
#CON ESTE FOR INICIALIZO LA VARIABLE
    ...
    for infile in l:
        ...
        # LEO LA FECHA DEL FICHERO .desc
            ...
            string0="grep  Time /home/kintxo/adjuntos/pruebas/"+ detalles + "> out0.txt"
            os.system(string0)
       ...
       # LEO LA POSICIÓN DEL FICHERO .desc
            ...
            string2="grep  Lat /home/kintxo/adjuntos/pruebas/" + detalles + "> out2.txt"
            os.system(string2)
      ...
      # LEO EL NÚMERO DE MENSAJE DEL FICHERO .desc
            ...
            string4="grep  MOMSN  /home/kintxo/adjuntos/pruebas/" + detalles + "> out4.txt"
            os.system(string4)
      ...
      # LEO EL TAMAÑO DE MENSAJE DEL FICHERO .desc
            ...
            string5="grep  Size  /home/kintxo/adjuntos/pruebas/" + detalles + "> out5.txt"
            os.system(string5)
      ...
      # LEO EL STATUS DEl MENSAJE DEL FICHERO .desc
            ...
            string6="grep  Status  /home/kintxo/adjuntos/pruebas/" + detalles + "> out6.txt"
            os.system(string6)
       ...
       # LEO TODOS LOS VALORES  DEL FICHERO .sbd,TEMPERATURA,CONDUCTIVIDAD,HUMEDAD,TENSION,TIEMPOGPS Y POSICIÓN REAL
            ...
            string7= """tr "," " " <  /home/kintxo/adjuntos/pruebas/""" + posiciones +  "> out7.txt" # quita todas las comnas y las cambia por espacios. Si hago este comando para que no deje nada no funciona ["tr "," ""]
            os.system(string7)
...
def plotea_posiciones(data,outputname,cmin,cmax,var,nombre):
    ...
    if len(data['lonREAL'])>1: # si el fichero tiene valores validos, len(drifter) > 1 
        ...
        pc2=map1.scatter(data['lonREAL'], data['latREAL'], c= data[var], s=30.0, norm = colors.BoundaryNorm(t,ncolors=256, clip = False),edgecolor='none')   

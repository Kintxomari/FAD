...
def main():
    ...
    dir_folder='/home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/'
...
#CON ESTE FOR INICIALIZO LA VARIABLE
    ...
    for infile in l:
        ...
        # LEO LA FECHA DEL FICHERO .desc
            ...
            string0="grep  Time  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/" + detalles + "> out0.txt"
            os.system(string0)
       ...
       # LEO LA POSICIÓN DEL FICHERO .desc
            ...
            string2="grep  Lat  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/" + detalles + "> out2.txt"
            os.system(string2)
      ...
      # LEO EL NÚMERO DE MENSAJE DEL FICHERO .desc
            ...
            string4="grep  MOMSN  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/" + detalles + "> out4.txt"
            os.system(string4)
      ...
      # LEO EL TAMAÑO DE MENSAJE DEL FICHERO .desc
            ...
            string5="grep  Size  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/" + detalles + "> out5.txt"
            os.system(string5)
      ...
      # LEO EL STATUS DEl MENSAJE DEL FICHERO .desc
            ...
            string6="grep  Status  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/" + detalles + "> out6.txt"
            os.system(string6)
       ...
       # LEO TODOS LOS VALORES  DEL FICHERO .sbd,TEMPERATURA,CONDUCTIVIDAD,HUMEDAD,TENSION,TIEMPOGPS Y POSICIÓN REAL
            ...
            string7= """tr "," " " <  /home/kintxo/TIC-MOC/Campanya/BoyasInstrumentadas/300234062219200/""" + posiciones +  "> out7.txt" # quita todas las comnas y las cambia por espacios. Si hago este comando para que no deje nada no funciona ["tr "," ""]
            os.system(string7)
...
def plot_velocidades(data):
    ...
    plt.plot(data['date'],data['velocidad'],'.',markersize=5,color=('b'))
...
def guarda_netCDF4(data):
    ...
    wf=Dataset('300234062219200.nc','w',format='NETCDF4')
...
def guardo_diccionario(data):
    ...
    fichero = file("300234062219200.dat", "w") 
